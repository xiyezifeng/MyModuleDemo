...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        GroupInfoEntityDao.createTable(db, ifNotExists);
        SystemNotifyEntityDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        UserInfoEntityDao.dropTable(db, ifExists);
        GroupInfoEntityDao.dropTable(db, ifExists);
        SystemNotifyEntityDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(SystemNotifyEntityDao.class);
    }
